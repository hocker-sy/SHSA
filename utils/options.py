...
def get_args():
    ...
    parser.add_argument("--masked_token_rate", type=float, default=0.2, help="masked token rate for mlm task")
    ...
    ######################## loss settings ########################
    parser.add_argument("--loss_names", default='', help="which loss to use ['mlm', 'cmpm', 'id', 'itc', 'sdm']")
    ...
    ######################## dataset ########################
    parser.add_argument("--dataset_name", default="RSITMD", help="[RSICD, RSITMD]")
    ...
    ####################### circle loss ########################
    parser.add_argument("--circle_loss", default=True, action='store_true')
    parser.add_argument("--circle_margin", type=float, default=0.5)
    parser.add_argument("--circle_gamma", type=float, default=8)
    parser.add_argument("--circle_metric", default='cosine', help="['cosine', 'euclidean']")
