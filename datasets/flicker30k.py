...
class FLICKER30K(BaseDataset):
    dataset_dir = 'f30k'
    def __init__(self, root='', verbose=True):
        super(FLICKER30K, self).__init__()
        root = r'/root/autodl-tmp/data/'
        self.dataset_dir = op.join(root, self.dataset_dir)
        self.img_dir = op.join(self.dataset_dir, 'images/')

        self.anno_path = op.join(self.dataset_dir, 'dataset_flickr30k_transformed.json')
